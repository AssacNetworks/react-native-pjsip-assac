...
//            mHandler = new Handler(Looper.getMainLooper());
    ...
    private void handle(Intent intent) {
        ...
        switch (intent.getAction()) {
            ...
            case PjActions.ACTION_CHANGE_CODEC_SETTINGS:
                ...
                break;
            // case PjActions.ACTION_GET_CODEC_SETTINGS:
            // handleGetCodecSettings(intent);
            // break;
    ...
    private PjSipAccount doAccountCreate(AccountConfigurationDTO configuration) throws Exception {
        ...
        // Shabtai
        //cfg.getMediaConfig().setThreadCnt(1);
        ...
        // Shabtai, i've commented these settings out
...
//        }
    ...
    // private void handleGetCodecSettings(Intent intent) {
    // try {
