...
public class PjActions {
    ...
    //public static final String ACTION_GET_CODEC_SETTINGS= "get_codec_settings'";
    ...
    // public static Intent createGetCodecSettingsIntent(int callbackId, Context context) {
    // Intent intent = new Intent(context, PjSipService.class);
    // intent.setAction(PjActions.ACTION_GET_CODEC_SETTINGS);
    // intent.putExtra("callback_id", callbackId);
